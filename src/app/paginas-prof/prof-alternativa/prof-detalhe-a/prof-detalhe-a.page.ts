...
@Component({
  selector: 'app-prof-detalhe-a', // Único para o componente A
  templateUrl: './prof-detalhe-a.page.html', // Aponta para o HTML do A
  styleUrls: ['./prof-detalhe-a.page.scss'],
  standalone: true,
  imports: [
...
export class ProfDetalheAPage implements OnInit { // Nome da classe para o A
  profId: string | null = '';
  expedicoes: any[] = [];
